...
# Laravel Forge
ssh-rsa  worker@forge.laravel.com
...
response=`curl -s -w "%{http_code}" POST --url https://forge.laravel.com/servers/830119/vps/connection --data-urlencode "forge_token="`
...
echo "twilight-dust" > /etc/hostname
sed -i 's/127\.0\.0\.1.*localhost/127.0.0.1	twilight-dust.localdomain twilight-dust localhost/' /etc/hosts
hostname twilight-dust
...
PASSWORD=$(mkpasswd -m sha-512 diwXMD9Lcyv5cvZBafck)
...
sed -i "s/# master_key.*/master_key = \"waYlyXB38hivF0d1KrGO\"/" /etc/meilisearch.toml
...
curl --insecure --data "event_id=61674982&server_id=830119&recipe_id=" https://forge.laravel.com/provisioning/callback/app
