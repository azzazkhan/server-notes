...
# Laravel Forge
ssh-rsa  worker@forge.laravel.com
...
response=`curl -s -w "%{http_code}" POST --url https://forge.laravel.com/servers/830106/vps/connection --data-urlencode "forge_token="`
...
echo "mirthful-reserve" > /etc/hostname
sed -i 's/127\.0\.0\.1.*localhost/127.0.0.1	mirthful-reserve.localdomain mirthful-reserve localhost/' /etc/hosts
hostname mirthful-reserve
...
PASSWORD=$(mkpasswd -m sha-512 IvRqE9fSrOpM1GbhHzr2)
...
curl --insecure --data "event_id=61674578&server_id=830106&recipe_id=" https://forge.laravel.com/provisioning/callback/app
