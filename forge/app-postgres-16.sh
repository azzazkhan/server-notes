...
# Laravel Forge
ssh-rsa  worker@forge.laravel.com
...
response=`curl -s -w "%{http_code}" POST --url https://forge.laravel.com/servers/830105/vps/connection --data-urlencode "forge_token="`
...
echo "lingering-rain" > /etc/hostname
sed -i 's/127\.0\.0\.1.*localhost/127.0.0.1	lingering-rain.localdomain lingering-rain localhost/' /etc/hosts
hostname lingering-rain
...
PASSWORD=$(mkpasswd -m sha-512 QUs81TYfGkaODe3m1aan)
...
sudo -u postgres psql -c "CREATE ROLE forge LOGIN PASSWORD 'qT3esOWhT3APFKytDrcM' SUPERUSER INHERIT NOCREATEDB NOCREATEROLE NOREPLICATION;"
...
curl --insecure --data "event_id=61674525&server_id=830105&recipe_id=" https://forge.laravel.com/provisioning/callback/app
